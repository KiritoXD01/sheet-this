...
it('renders employee index page successfully', function () {
...
it('can search employees by email', function () {
    $employee1 = Employee::factory()->create([
        'company_id' => $this->company->id,
        'user_id' => User::factory()->create(['email' => 'john@example.com'])->id,
    ]);
    $employee2 = Employee::factory()->create([
        'company_id' => $this->company->id,
        'user_id' => User::factory()->create(['email' => 'jane@example.com'])->id,
    ]);
