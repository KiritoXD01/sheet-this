...
* @see app/Http/Controllers/Auth/NewPasswordController.php:20
...
/**
* @see \App\Http\Controllers\Auth\NewPasswordController::update
* @see app/Http/Controllers/Auth/NewPasswordController.php:28
