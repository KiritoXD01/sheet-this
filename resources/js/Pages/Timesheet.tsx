...
export default function Timesheet() {
    const entries: TimesheetEntry[] = [
        { id: 1, name: 'Brand Redesign', client: 'Acme Corp', mon: '3:30', tue: '4:00', wed: '2:15', thu: '3:45', fri: '2:00', sat: '—', sun: '—', total: '15:30', color: 'bg-accent' },
    ...
    const dailyTotals: Record<Day, string> = { mon: '6:30', tue: '6:00', wed: '7:45', thu: '7:15', fri: '4:45', sat: '2:00', sun: '—' };
                ...
                <div className="flex flex-col gap-6 h-full">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-gray-500 text-[13px] font-inter">Track your weekly hours by project</p>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <button className="border border-gray-200 rounded-md px-2.5 py-2 hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-accent font-jetbrains font-bold text-xl">34:15</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 flex flex-col flex-1 overflow-hidden">
                        {/* Table Header */}
                        <div className="bg-inset px-4 py-3 flex items-center border-b border-gray-200">
                            ...
                            {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day, i) => (
                                <div key={day} className="flex-1 flex flex-col items-center gap-0.5">
                                    <span className="text-gray-900 text-[10px] font-jetbrains font-semibold tracking-wider uppercase">{day}</span>
                        ...
                        {/* Table Rows */}
                        {entries.map((entry) => (
                            <div key={entry.id} className="px-4 py-3.5 flex items-center border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        {/* Daily Totals Row */}
                        <div className="bg-inset px-4 py-3.5 flex items-center border-t border-gray-200">
                            <div className="w-[200px] flex-shrink-0">
                            ...
                            <div className="w-[70px] flex-shrink-0 text-right">
                                <span className="text-accent text-[13px] font-jetbrains font-bold">34:15</span>
                            </div>
                        </div>
                    </div>
