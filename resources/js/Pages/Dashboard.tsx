            ...
            <div className="flex h-full">
                ...
                <div className="flex-1 p-8 overflow-y-auto">
                    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
                        ...
                        {/* Active Timer */}
                        <div className="bg-white rounded-xl border border-gray-200 px-7 py-6 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-5">
                                <span className="text-accent font-jetbrains font-bold text-4xl tracking-tight">01:24:37</span>
                                <button className="bg-danger hover:bg-danger/90 transition-colors text-white rounded-md px-5 py-3 flex items-center gap-2 font-jetbrains text-xs font-semibold tracking-widest">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-3">
                                {entries.map((entry) => (
                                    <div key={entry.id} className="bg-white rounded-lg border border-gray-200 px-4 py-3.5 flex items-center justify-between hover:bg-inset transition-colors cursor-pointer">
                                        ...
                                        <span className="text-accent font-jetbrains font-semibold text-sm">{entry.duration}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {/* Right Sidebar */}
                <aside className="w-[300px] shrink-0 bg-white px-6 py-8 flex flex-col gap-6 overflow-y-auto hidden xl:flex">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-5 flex flex-col gap-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-accent font-jetbrains font-bold text-xl">32:45</span>
                        </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-5 flex flex-col gap-3">
                        ...
                        <span className="text-accent font-jetbrains font-bold text-[32px] leading-none">04:57</span>
