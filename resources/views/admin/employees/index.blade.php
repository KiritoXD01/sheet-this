...
@section('content')
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
        ...
        <div class="flex items-center gap-3">
            <button
                class="px-5 py-2.5 rounded-lg bg-white dark:bg-card-dark border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-medium text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <div
            ...
            <div class="absolute top-4 right-4 z-10">
                <button class="text-slate-400 hover:text-primary p-1 rounded-full hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
            ...
            <div class="p-6 flex flex-col items-center text-center grow">
                <div class="relative mb-4">
                    ...
                    <span class="absolute bottom-0 right-0 w-5 h-5 bg-green-500 border-2 border-white dark:border-card-dark rounded-full"
                        title="Active"></span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-lg">Jane Cooper</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400 mb-1">Software Developer</p>
        ...
        <div
            ...
            <div class="p-6 flex flex-col items-center text-center grow">
                <div class="relative mb-4">
                    <img alt="Wade Warren" class="h-20 w-20 rounded-full object-cover border-2 border-white dark:border-card-dark shadow-sm"
                    ...
                    <span class="absolute bottom-0 right-0 w-5 h-5 bg-amber-400 border-2 border-white dark:border-card-dark rounded-full"
                        title="On Leave"></span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-lg">Wade Warren</h3>
        ...
        <div
            ...
            <div class="p-6 flex flex-col items-center text-center grow">
                <div class="relative mb-4">
                    <div
                        class="h-20 w-20 rounded-full bg-pink-100 text-pink-600 flex items-center justify-center text-2xl font-bold border-2 border-white dark:border-card-dark shadow-sm">
                        EF
                    </div>
                    <span class="absolute bottom-0 right-0 w-5 h-5 bg-green-500 border-2 border-white dark:border-card-dark rounded-full"
                        title="Active"></span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-lg">Esther Howard</h3>
            ...
            <div class="p-6 flex flex-col items-center text-center grow">
                <div class="relative mb-4">
                    <img alt="Cameron Williamson"
                        class="h-20 w-20 rounded-full object-cover border-2 border-white dark:border-card-dark shadow-sm"
                    ...
                    <span class="absolute bottom-0 right-0 w-5 h-5 bg-slate-400 border-2 border-white dark:border-card-dark rounded-full"
                        title="Inactive"></span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-lg">Cameron W.</h3>
        ...
        <div
            ...
            <div class="p-6 flex flex-col items-center text-center grow">
                <div class="relative mb-4">
                    <div
                        class="h-20 w-20 rounded-full bg-cyan-100 text-cyan-600 flex items-center justify-center text-2xl font-bold border-2 border-white dark:border-card-dark shadow-sm">
                        BJ
                    </div>
                    <span class="absolute bottom-0 right-0 w-5 h-5 bg-green-500 border-2 border-white dark:border-card-dark rounded-full"
                        title="Active"></span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-lg">Brooklyn Juarez</h3>
        ...
        <div
            ...
            <div class="p-6 flex flex-col items-center text-center grow">
                <div class="relative mb-4">
                    ...
                    <span class="absolute bottom-0 right-0 w-5 h-5 bg-blue-400 border-2 border-white dark:border-card-dark rounded-full"
                        title="Onboarding"></span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-slate-100 text-lg">Leslie Alexander</h3>
    ...
    <div class="mt-8 flex items-center justify-between border-t border-slate-100 dark:border-slate-700 pt-6">
        <div class="text-sm text-slate-500 dark:text-slate-400">
            Showing <span class="font-medium text-slate-900 dark:text-slate-100">1</span> to <span class="font-medium text-slate-900 dark:text-slate-100">6</span>
            of <span class="font-medium text-slate-900 dark:text-slate-100">42</span> results
        </div>
        <div class="flex gap-2">
            <button
                class="px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                disabled="">
                Previous
            </button>
            <button
                class="px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                Next
            </button>
        </div>
    </div>
