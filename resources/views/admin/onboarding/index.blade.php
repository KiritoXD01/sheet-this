    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg p-4 flex gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700 dark:text-blue-400 mt-0.5">You can add more details like logo, address, and company policies later from the company profile page.</p>
            </div>
        </div>
    </div>
@endsection
