<div id="job-role-container" class="bg-white rounded-2xl shadow-soft border border-slate-100 overflow-hidden">
    ...
    @forelse ($jobRoles as $jobRole)
        ...
        <tr class="group hover:bg-slate-50 transition-colors">
            <td class="px-6 py-4">
                <div class="font-medium text-slate-900">{{ $jobRole->name }}</div>
            </td>
...
<div class="p-12 text-center">
    ...
    <p class="text-slate-500 mt-4 text-sm">No job roles yet. Create your first job role.</p>
</div>
@endforelse
