...
<form wire:submit="submit" class="p-6 md:p-8 space-y-6">
    ...
    <button type="submit" wire:loading.attr="disabled"
        class="w-full px-5 py-3 rounded-lg bg-primary hover:bg-primary-hover text-white font-medium text-sm shadow-glow transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50">
